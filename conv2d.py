...
class Conv2d(Layer):
    ...
    def create_layer(self, input):
        ...
        with tf.variable_scope('conv', reuse=False):#reuse=False, or tf.AUTO_REUSE? it was originally False
    ...
    def create_layer_reversed(self, input, prev_layer=None):
        ...
        with tf.variable_scope('conv', reuse=True):#reuse=True, or tf.AUTO_REUSE
